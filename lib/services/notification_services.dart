...
class NotifyHelper {
  ...
  displayNotification({required String title, required String body}) async {
    ...
    var androidPlatformChannelSpecifics = const AndroidNotificationDetails(
        ...
        channelDescription: 'your Channel descriptiob',
  ...
  canselscheduledNotification(Task task) async {
    await flutterLocalNotificationsPlugin.cancel(task.id!);
    print("Notification cansled");
  }
  canselsAllcheduledNotification() async {
    await flutterLocalNotificationsPlugin.cancelAll();
    print("All Notifications cansled");
  }
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    print("notifif is $scheduledDate");
  ...
  //   }
  //   Get.to(() => const NotificationScreen(payload: 'selectedNotificationPayload',));
  // }
